...
import { subtaskToFirebase } from "../../../data/task";
import { useForm } from "../../hooks/useForm";
import { useDispatch } from "react-redux";
import { startCreateSubTask } from "../../../store/todos/taskThunk";
...
export const CreateSubtask = () => {
  ...
  const { formState, onInputChange } = useForm(subtaskToFirebase);
  ...
  const onClickCreateSubTask = () => {
    Swal.fire({
      ...
      if (result.isConfirmed) {
        dispatch(startCreateSubTask(formState, images));
        Swal.fire({
          title: "Created!",
          icon: "success",
          target: document.getElementById("form-modal"),
      ...
      >
        <Box sx={style}>
          ...
          <Grid container>
            ...
            <IconButton color="secondary" onClick={onClickCreateSubTask}>
              <SaveOutlined sx={{ fontSize: 30, mr: 1 }} />
              <Typography>Create subtask</Typography>
            </IconButton>
          </Grid>
        </Box>
      </Modal>

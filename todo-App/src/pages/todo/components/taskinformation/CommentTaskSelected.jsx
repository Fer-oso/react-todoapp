          ...
          <Grid container sx={{ mb: 2, mt: 1, ml: 0 }} >
            <Grid item xs={12} md={6}>
              <Button variant="contained" fullWidth>
                <Typography variant="body1" fontWeight={"fontWeightBold"}>Public changes</Typography>
              </Button>
            </Grid>

            <Grid item xs={12} md={6}>
              <Button variant="contained" fullWidth>
                <Typography variant="body1" fontWeight={"fontWeightBold"}>Public comment</Typography>
              </Button>
            </Grid>
          </Grid>
        </form>
